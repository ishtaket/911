...
| Cleartext exfil of window context to the bridge | Network Security Config denies cleartext by default; cleartext allowed **only** for RFC-1918 + loopback (intentional LAN bridge story) | `PCA-S-2` | `res/xml/network_security_config.xml` |
